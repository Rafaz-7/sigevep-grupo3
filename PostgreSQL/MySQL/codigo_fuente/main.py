...
try:
    ...
    print('Instale dependencias: pip install mysql-connector-python rich')
    sys.exit(1)
...
def mostrar_banner():
    ...
    banner.append('CRUD + SP + Triggers — Avance 03', style='dim italic')
...
def menu_principal():
    try:
        conn = get_connection()
        console.print('[green]Conexion a MySQL establecida.[/]\n')
    except Exception as e:
        console.print(f'[bold red]Error de conexion a MySQL:[/] {e}')
        sys.exit(1)
